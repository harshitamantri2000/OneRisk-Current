...
import svgPaths from "./svg-r2jq20oy3k";
type BadgeChipProps = {
...
export default function FullView() {
  return (
    <div className="bg-[#f3f3f4] relative size-full" data-name="Full view">
      ...
      <div className="absolute bottom-0 h-[1493px] left-0 pointer-events-none top-0">
      ...
      <div className="absolute bg-white content-stretch flex flex-col h-[908px] items-start left-[128px] rounded-[12px] top-[403px] w-[1265px]">
