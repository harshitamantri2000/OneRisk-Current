...
import svgPaths from "./svg-et50l4rtp";
type BadgeChipProps = {
...
export default function IfTheyaAreClcikingByDefaultAnywhere() {
  return (
    <div className="bg-[#f3f3f4] relative size-full" data-name="If theya are clciking by default anywhere">
      ...
      <div className="-translate-x-1/2 absolute bg-[#131a25] left-[calc(50%-0.5px)] rounded-[4px] shadow-[0px_12px_24px_0px_rgba(19,26,37,0.12)] top-[118px]" data-name="Toasts/Snackbar">
        <div className="flex flex-row justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-start justify-center relative">
            <div className="content-stretch flex items-center justify-center p-[12px] relative shrink-0" data-name="content-container">
              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[14px] text-white tracking-[0.056px]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>{`Select Risk In Case decision for generating report. `}</p>
            </div>
          </div>
        </div>
      </div>
