...
import svgPaths from "./svg-cwdl9q2p1o";
type Wrapper3Props = {
  ...
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      ...
      <div className="bg-[#eceded] flex-[1_0_0] min-h-px min-w-px relative rounded-tr-[4px]" data-name="Content Cell">
        <div className="flex flex-row items-center size-full">
          <Text5 text="Date of Registration" additionalClassNames="px-[8px] py-[12px]" />
        </div>
      </div>
      <ContentCellText1 text="State" additionalClassNames="flex-[1_0_0] min-h-px min-w-px">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
...
function ContentCell13({ additionalClassNames = "" }: ContentCell13Props) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-row items-center size-full">
        <Text5 text="8.33 Cr" additionalClassNames="px-[8px] py-[10px]" />
      </div>
    </div>
  );
}
...
function ContentCell12({ additionalClassNames = "" }: ContentCell12Props) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-row items-center size-full">
        <Text5 text="183.99 Cr" additionalClassNames="px-[8px] py-[10px]" />
      </div>
    </div>
  );
}
...
function ContentCell11({ additionalClassNames = "" }: ContentCell11Props) {
  return (
    <div className="relative shrink-0 w-[330px]">
      <div className="flex flex-row items-center size-full">
        <Text5 text="Total Current Liablities" additionalClassNames="px-[44px] py-[10px]" />
      </div>
    </div>
  );
}
...
function ContentCellText5({ text, additionalClassNames = "" }: ContentCellText5Props) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-row items-center size-full">
        <Text5 text={text} additionalClassNames="px-[8px] py-[10px]" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <div className="relative shrink-0 w-[330px]" data-name="Content Cell">
        <div className="flex flex-row items-center size-full">
          <Text5 text={text} additionalClassNames="px-[20px] py-[10px]" />
        </div>
      </div>
...
function ContentCell({ children, additionalClassNames = "" }: React.PropsWithChildren<ContentCellProps>) {
  return (
        ...
        <div className="content-stretch flex gap-[4px] items-center px-[8px] py-[10px] relative w-full">
          ...
          <div className="overflow-clip relative rounded-[5.333px] shrink-0 size-[20px]" data-name="Upload statement">
            <div className="absolute inset-[4.17%_13.33%_3.12%_12.5%]">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.8348 18.5435">
                <g id="Group 28">
                  <path d={svgPaths.p1fbef600} fill="var(--fill-0, #E23318)" id="contact_page" />
                  <g id="PDF">
                    <path d={svgPaths.p24a07480} fill="var(--fill-0, white)" />
                    <path d={svgPaths.p377d5380} fill="var(--fill-0, white)" />
                    <path d={svgPaths.pd2c4200} fill="var(--fill-0, white)" />
                  </g>
                </g>
              </svg>
            </div>
...
export default function Old() {
  return (
    <div className="bg-[#f3f3f4] relative size-full" data-name="Old">
                    ...
                    <div className="content-start flex flex-wrap items-start overflow-clip relative rounded-[inherit] w-full">
                      <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
                        ...
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                          ...
                          <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="Badge/Chip">
                            <div className="flex flex-row items-center size-full">
                              <div className="content-stretch flex gap-[4px] items-center pb-[8px] pt-[10px] px-[12px] relative w-full">
                                <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[#131a25] text-[14px] tracking-[0.056px]" style={{ fontFeatureSettings: "'case'" }}>
                                  11,00,000
                                </p>
                                <div className="bg-[#fef0e6] content-stretch flex gap-[4px] items-center justify-center px-[4px] py-[2px] relative rounded-[4px] shrink-0" data-name="Button">
                                  <div className="flex items-center justify-center relative shrink-0">
                                    <div className="flex-none rotate-180">
                                      <div className="relative size-[16px]" data-name="Icon">
                                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                                          <g id="Icon">
                                            <path d={svgPaths.p1bd8fbc0} id="Vector" stroke="var(--stroke-0, #E23318)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                                            <path d={svgPaths.pbe33728} id="Vector_2" stroke="var(--stroke-0, #E23318)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                                          </g>
                                        </svg>
                                      </div>
                                    </div>
                                  </div>
                                  <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.3] relative shrink-0 text-[#e23318] text-[12px] text-center tracking-[0.048px]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                                    5%
                                  </p>
                                </div>
                              </div>
                ...
                <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] py-[12px] relative w-full">
                  ...
                  <div className="bg-white relative rounded-[8px] shrink-0 w-full">
                    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
                      ...
                      <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full">
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                          <ContentCell additionalClassNames="w-[330px]">
                        ...
                        <Helper2 text="Total Current Liablities" text1="185.99" text2="186.99" text3="187.99" />
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                          <div aria-hidden="true" className="absolute border border-[#e7e8e9] border-solid inset-[-1px] pointer-events-none" />
                          <div className="bg-white content-stretch flex gap-[4px] items-center px-[16px] py-[8px] relative shrink-0 w-[223px]" data-name="Content Cell">
                            <Helper1 />
                        ...
                        <Helper2 text="Total Current Liablities" text1="183.99 Cr" text2="40.64 Cr" text3="8.33 Cr" />
                      </div>
                    </div>
                    <div aria-hidden="true" className="absolute border border-[#bfc2c4] border-solid inset-0 pointer-events-none rounded-[8px]" />
                  </div>
                  <div className="bg-white relative rounded-[8px] shrink-0 w-full">
                    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
                      ...
                      <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full">
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                          <ContentCell additionalClassNames="w-[350px]">
                            <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #7D8187)" strokeLinecap="round" />
                          </ContentCell>
                        ...
                        <Text6 text="Cost of Materials Consumed" />
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                        ...
                        <Text7 text="Inventory Adjustments / Change in Inventory" />
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                        ...
                        <Text7 text="Profit from Discontinuing Operations After Tax" />
                        <Helper3 />
                      </div>
                    </div>
                    <div aria-hidden="true" className="absolute border border-[#bfc2c4] border-solid inset-0 pointer-events-none rounded-[8px]" />
              ...
              <div className="overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] py-[12px] relative w-full">
                  <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
                    ...
                    <div className="bg-[#e8fcfb] content-stretch flex items-center justify-center px-[4px] py-[2px] relative rounded-[4px] shrink-0" data-name="Button">
                      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#003464] text-[0px] text-[12px] text-center tracking-[0.048px]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                        <span className="leading-[1.3]">{`Sum of Charges: `}</span>
                        <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.3]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                          50,00,00
                        </span>
                      </p>
                    </div>
