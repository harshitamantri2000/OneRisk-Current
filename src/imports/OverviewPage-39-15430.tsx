...
import svgPaths from "./svg-chrilx3rdq";
...
function BackgroundImage({ text, text1 }: BackgroundImageProps) {
  return (
    <div className="content-stretch flex font-['Plus_Jakarta_Sans:Medium',sans-serif] gap-[3px] items-start relative shrink-0">
              ...
              <div className="content-stretch flex items-center justify-between px-[16px] py-[8px] relative w-full">
                <div className="content-stretch flex items-center relative shrink-0 w-[1100px]">
                  <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
                    <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[#131a25] text-[18px] tracking-[0.072px]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>{` Overview of Aditya Rajesh`}</p>
                  </div>
                </div>
                ...
                <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Timeline">
                      ...
                      <BackgroundImage7 additionalClassNames="bg-white">
                      ...
                      <BackgroundImage7 additionalClassNames="bg-[rgba(255,255,255,0)] w-[164px]">
                    ...
                    <div className="content-stretch flex items-start relative shrink-0 w-full">
                      ...
                      <div className="bg-white content-stretch flex flex-col items-center justify-center px-[8px] py-[2px] relative self-stretch shrink-0 w-[257px]">
                        <div aria-hidden="true" className="absolute border-[#e7e8e9] border-r border-solid inset-0 pointer-events-none" />
                        <BackgroundImageAndText2 text="2" additionalClassNames="bg-[#1766d6] shadow-[0px_1px_4px_0px_rgba(19,26,37,0.2)]" />
                      </div>
                      <BackgroundImage3 additionalClassNames="w-[203px]" />
                      <BackgroundImage4 additionalClassNames="bg-white w-[293px]" />
                      <BackgroundImage3 additionalClassNames="w-[164px]" />
                      <BackgroundImage5 />
                    </div>
                    <div className="content-stretch flex items-start relative shrink-0 w-full">
                      <div aria-hidden="true" className="absolute border-[#f3f3f4] border-b border-solid inset-0 pointer-events-none" />
                      ...
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[257px]" />
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[203px]" />
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[293px]" />
                      <BackgroundImage6 additionalClassNames="bg-[#f3f3f4] w-[164px]" />
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[202px]" />
                    </div>
                    <div className="content-stretch flex items-start relative shrink-0 w-full">
                      <div aria-hidden="true" className="absolute border-[#f3f3f4] border-b border-solid inset-0 pointer-events-none" />
                      <div className="bg-white content-stretch flex flex-col items-center justify-center px-[8px] py-[12px] relative self-stretch shrink-0 w-[105px]">
                      ...
                      <BackgroundImage4 additionalClassNames="bg-white w-[257px]" />
                      <BackgroundImage3 additionalClassNames="w-[203px]" />
                      <BackgroundImage4 additionalClassNames="bg-white w-[293px]" />
                      <BackgroundImage3 additionalClassNames="w-[164px]" />
                      <BackgroundImage5 />
                    ...
                    <div className="content-stretch flex items-start relative shrink-0 w-full">
                      ...
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[203px]" />
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[293px]" />
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[164px]" />
                      <BackgroundImage4 additionalClassNames="bg-[#f3f3f4] w-[202px]" />
                    </div>
                    <div className="content-stretch flex items-start relative shrink-0 w-full">
                      <div aria-hidden="true" className="absolute border-[#f3f3f4] border-b border-solid inset-0 pointer-events-none" />
