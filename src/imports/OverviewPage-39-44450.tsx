...
import svgPaths from "./svg-9t7vgakb0y";
type Wrapper3Props = {
...
function Text2({ text, children }: React.PropsWithChildren<Text2Props>) {
  return (
    <div className="content-stretch flex gap-[4px] items-start p-[12px] relative w-full">
      <div className="bg-[#fafafb] relative rounded-[8px] shrink-0 size-[32px]" data-name="Control">
...
function Wrapper1({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper1Props>) {
  return (
    <div className="bg-[#f3f3f4] content-stretch flex items-start relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#e7e8e9] border-solid inset-0 pointer-events-none" />
      <ContentCellText2 text="03AAAC15950L2ZJ" />
      <ContentCellText3 text="Criminal" additionalClassNames="shrink-0 w-[123px]" />
      <ContentCellText3 text="Magistrate Court" additionalClassNames="shrink-0 w-[151px]" />
      <ContentCellText3 text="Income Tax violations" additionalClassNames="shrink-0 w-[200px]" />
      <div className="flex-[1_0_0] h-[40px] min-h-px min-w-px relative" data-name="Content Cell">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[4px] items-center px-[8px] py-[10px] relative size-full">
            <div className="bg-[#fde7da] relative rounded-[4px] shrink-0" data-name="Badge/Chip">
              <div className="flex flex-row items-center size-full">
      ...
      <ContentCellText3 text="Disposed" additionalClassNames="flex-[1_0_0] min-h-px min-w-px" />
      <ContentCellText4 text="View Details" />
    </div>
  );
}
type Text1Props = {
...
function Text1({ text }: Text1Props) {
  return (
    <Wrapper text="03AAAC15950L2ZJ" text1="Criminal" text2="Magistrate Court" text3="Income Tax violations" text4="Disposed" text5="View Details">
...
function ContentCellText4({ text }: ContentCellText4Props) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[8px] py-[10px] relative w-full">
          <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.4] min-h-px min-w-px overflow-hidden relative text-[#1766d6] text-[14px] text-ellipsis tracking-[0.056px] whitespace-nowrap" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
            {text}
          </p>
        </div>
      </div>
...
function ContentCellText3({ text, additionalClassNames = "" }: ContentCellText3Props) {
  return (
...
function ContentCellText2({ text }: ContentCellText2Props) {
  return (
...
function Wrapper({ text, text1, text2, text3, text4, text5, children }: React.PropsWithChildren<WrapperProps>) {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <ContentCellText2 text={text} />
      <ContentCellText3 text={text1} additionalClassNames="shrink-0 w-[123px]" />
      <ContentCellText3 text={text2} additionalClassNames="shrink-0 w-[151px]" />
      <ContentCellText3 text={text3} additionalClassNames="shrink-0 w-[200px]" />
      <div className="flex-[1_0_0] h-[40px] min-h-px min-w-px relative" data-name="Content Cell">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[4px] items-center px-[8px] py-[10px] relative size-full">
            <div className="bg-[#fde7da] relative rounded-[4px] shrink-0" data-name="Badge/Chip">
      ...
      <ContentCellText3 text={text4} additionalClassNames="flex-[1_0_0] min-h-px min-w-px" />
      <ContentCellText4 text={text5} />
    </div>
  );
}
type Helper1Props = {
...
function Helper1({ additionalClassNames = "" }: Helper1Props) {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <ContentCellText text="CIN No">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
      </ContentCellText>
      <ContentCellText1 text="Case Type" additionalClassNames="shrink-0 w-[123px]">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
      </ContentCellText1>
      <ContentCellText1 text="Court Type" additionalClassNames="flex-[1_0_0] min-h-px min-w-px">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
      </ContentCellText1>
      <ContentCellText1 text="Severity" additionalClassNames="shrink-0 w-[200px]">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
      </ContentCellText1>
      <ContentCellText1 text="Risk" additionalClassNames="flex-[1_0_0] min-h-px min-w-px">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
      </ContentCellText1>
      <ContentCellText1 text="Case Status" additionalClassNames="flex-[1_0_0] min-h-px min-w-px">
        <path d="M0.5 0.5H24.5" id="Right Separator" stroke="var(--stroke-0, #E7E8E9)" strokeLinecap="round" />
      </ContentCellText1>
...
function ContentCellText({ text, children }: React.PropsWithChildren<ContentCellTextProps>) {
  return (
    <div className="bg-[#eceded] relative shrink-0 w-[171px]">
      <div className="flex flex-row items-center size-full">
    ...
    <div className="bg-[#f3f3f4] relative size-full" data-name="Overview page">
      <div className="absolute bg-white h-[1779px] left-[80px] overflow-x-clip overflow-y-auto top-[130px] w-[1360px]">
        <div className="absolute bg-white border-[#e7e8e9] border-l border-solid h-[1643px] left-[250px] overflow-x-clip overflow-y-auto top-0 w-[1110px]">
          <div className="absolute content-stretch flex flex-col h-[1300px] items-start left-[-1px] top-0 w-[1109px]">
              ...
              <div className="overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] py-[12px] relative w-full">
                  ...
                  <div className="bg-white relative rounded-[8px] shrink-0 w-full">
                    <div className="content-start flex flex-wrap gap-[0px_1062px] items-start overflow-clip relative rounded-[inherit] w-full">
                      ...
                      <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
                        ...
                        <Text1 text="High Risk" />
                        <Text1 text="High Risk" />
                        <div className="relative shrink-0 w-[1110px]" data-name="Pagination">
                          <Text2 text="..." />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white relative rounded-[8px] shrink-0 w-full">
                    <div className="content-start flex flex-wrap gap-[0px_1062px] items-start overflow-clip relative rounded-[inherit] w-full">
                      <div className="content-stretch flex gap-[24px] items-start px-[16px] py-[12px] relative shrink-0 w-[1077px]">
                        <Text text="Director Records" />
                        <Helper />
                      </div>
                      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[1077px]">
                        ...
                        <div className="content-stretch flex items-start relative shrink-0">
                          <div className="bg-white relative shrink-0">
                            <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative rounded-[inherit]">
                              <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#1766d6] text-[14px] tracking-[0.056px] whitespace-nowrap" start="1" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                                <li className="ms-[21px] whitespace-pre-wrap">
                                  <span className="leading-[1.4]">{`Reshma (10) `}</span>
                                </li>
                              </ol>
                            </div>
                            <div aria-hidden="true" className="absolute border-[#1766d6] border-b-2 border-solid inset-0 pointer-events-none" />
                          </div>
                          <div className="bg-white content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0">
                            <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#131a25] text-[14px] tracking-[0.056px] whitespace-nowrap" start="2" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                              <li className="ms-[21px] whitespace-pre-wrap">
                                <span className="leading-[1.4]">Rajesh Kanubhai Shah (2)</span>
                              </li>
                            </ol>
                          </div>
                          <div className="bg-white content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0">
                            <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#131a25] text-[14px] tracking-[0.056px] whitespace-nowrap" start="3" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                              <li className="ms-[21px] whitespace-pre-wrap">
                                <span className="leading-[1.4]">Rajesh Kanubhai Shah ( no record)</span>
                              </li>
                            </ol>
                          </div>
                          <div className="bg-white content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0">
                            <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#131a25] text-[14px] tracking-[0.056px] whitespace-nowrap" start="4" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                              <li className="ms-[21px] whitespace-pre-wrap">
                                <span className="leading-[1.4]">Priti Rajesh (2)</span>
                              </li>
                            </ol>
                          </div>
                        </div>
                        <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-[1076px]">
                          <Helper1 />
                          <Text1 text="High Risk" />
                          <Text1 text="High Risk" />
                          <Wrapper1>
                  ...
                  <div className="bg-white relative rounded-[8px] shrink-0 w-full">
                    <div className="content-start flex flex-wrap gap-[0px_1062px] items-start overflow-clip relative rounded-[inherit] w-full">
                      ...
                      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[1077px]">
                        <div aria-hidden="true" className="absolute border border-[#e7e8e9] border-solid inset-[-1px] pointer-events-none" />
                        <div className="content-stretch flex items-start relative shrink-0">
                          <div className="bg-white content-stretch flex items-center justify-center overflow-clip px-[4px] py-[8px] relative shrink-0">
                            <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#131a25] text-[14px] tracking-[0.056px] whitespace-nowrap" start="1" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                              <li className="ms-[21px] whitespace-pre-wrap">
                                <span className="leading-[1.4]">{`Reshma (10) `}</span>
                              </li>
                            </ol>
                          ...
                          <div className="bg-white relative shrink-0">
                            <div className="content-stretch flex items-center justify-center overflow-clip px-[4px] py-[8px] relative rounded-[inherit]">
                              <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#1766d6] text-[14px] tracking-[0.056px] whitespace-nowrap" start="2" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                                <li className="ms-[21px] whitespace-pre-wrap">
                                  <span className="leading-[1.4]">Rajesh Kanubhai Shah ( No Records)</span>
                                </li>
                              </ol>
                            </div>
                            <div aria-hidden="true" className="absolute border-[#1766d6] border-b-2 border-solid inset-0 pointer-events-none" />
                          ...
                          <div className="bg-white content-stretch flex items-center justify-center overflow-clip px-[4px] py-[8px] relative shrink-0">
                            <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#131a25] text-[14px] tracking-[0.056px] whitespace-nowrap" start="3" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                              <li className="ms-[21px] whitespace-pre-wrap">
                                <span className="leading-[1.4]">Rajesh Kanubhai Shah (15)</span>
                              </li>
                            </ol>
                          </div>
                          <div className="bg-white content-stretch flex items-center justify-center overflow-clip px-[4px] py-[8px] relative shrink-0">
                        ...
                        <div className="bg-white content-stretch flex flex-col items-center py-[16px] relative shrink-0 w-[1076px]">
                          <div className="bg-white content-stretch flex flex-col items-center justify-center relative shrink-0">
                            <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0">
                              <div className="bg-[#f3f3f4] overflow-clip relative rounded-[6px] shrink-0 size-[34px]" data-name="Bank Cuarntee">
                                <div className="absolute left-[4.96px] overflow-clip size-[24.083px] top-[4.96px]" data-name="Icon=fi:file-text">
                                  <div className="absolute inset-[4.58%_12.92%]" data-name="Vector">
                                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.8618 21.8757">
                                      <g id="Vector">
                                        <path clipRule="evenodd" d={svgPaths.p13065240} fill="var(--fill-0, #131A25)" fillRule="evenodd" />
                                        <path clipRule="evenodd" d={svgPaths.p32cdca00} fill="var(--fill-0, #131A25)" fillRule="evenodd" />
                                        <path clipRule="evenodd" d={svgPaths.p19176200} fill="var(--fill-0, #131A25)" fillRule="evenodd" />
                                        <path clipRule="evenodd" d={svgPaths.p18338900} fill="var(--fill-0, #131A25)" fillRule="evenodd" />
                                        <path clipRule="evenodd" d={svgPaths.p3dc2de00} fill="var(--fill-0, #131A25)" fillRule="evenodd" />
                                      </g>
                                    </svg>
                                  </div>
                                </div>
                                <div className="absolute left-[17px] size-[15px] top-[17px]" data-name="Icon=u:check-filled">
                                  <div className="absolute inset-[8.33%]">
                                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.5 12.5">
                                      <circle cx="6.25" cy="6.25" fill="var(--fill-0, #1A7A1E)" id="Ellipse 11" r="6.25" />
                                    </svg>
                                  </div>
                                  <div className="absolute inset-[37.5%_31.25%_35.23%_31.25%]" data-name="Vector">
                                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.625 4.09115">
                                      <path d={svgPaths.p19fd9200} fill="var(--fill-0, #DBE9FA)" id="Vector" />
                                    </svg>
                                  </div>
                                </div>
                              </div>
                              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.3] relative shrink-0 text-[#484e56] text-[12px] text-center tracking-[0.048px] w-[312px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                                No cases against director
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="content-start flex flex-wrap gap-[0px_1062px] items-start overflow-clip relative rounded-[inherit] w-full">
                      ...
                      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[1077px]">
                        ...
                        <div className="content-stretch flex items-start relative shrink-0">
                          ...
                          <div className="bg-white relative shrink-0">
                            <div className="content-stretch flex gap-[4px] items-center justify-center overflow-clip px-[4px] py-[8px] relative rounded-[inherit]">
                              <ol className="block font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#1766d6] text-[14px] tracking-[0.056px] whitespace-nowrap" start="2" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                                <li className="ms-[21px] whitespace-pre-wrap">
                                  <span className="leading-[1.4]">{`Rajesh Kanubhai Shah `}</span>
                                </li>
                              </ol>
                              <div className="overflow-clip relative shrink-0 size-[15px]" data-name="Icon=u:exclamation-filled">
                                <div className="absolute inset-[8.33%]">
                                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.5 12.5">
                        ...
                        <div className="bg-white content-stretch flex flex-col items-center py-[16px] relative shrink-0 w-[1076px]">
                          <div className="content-stretch flex flex-col items-center justify-center pb-[16px] relative shrink-0">
                            <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0">
                              <div className="bg-[#f3f3f4] overflow-clip relative rounded-[6px] shrink-0 size-[34px]" data-name="Bank Cuarntee">
                              ...
                              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.3] relative shrink-0 text-[#484e56] text-[12px] text-center tracking-[0.048px] w-[248px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                                Cases may exist, we are unable to fetch at this moment.
                              </p>
                            </div>
                          </div>
                        </div>
          ...
          <div className="-translate-x-1/2 absolute bg-[#f3f3f4] h-[28px] left-[calc(50%-0.5px)] rounded-[4px] top-[1258px] w-[80px]" data-name="button">
                    ...
                    <div className="content-stretch flex items-center justify-between px-[12px] relative w-full">
                      <div className="content-stretch flex items-center relative shrink-0" data-name="arrow">
                        <div className="h-[35px] relative shrink-0 w-px" data-name="Container">
                          <div aria-hidden="true" className="absolute border-[#bfc2c4] border-l border-solid inset-0 pointer-events-none" />
                        </div>
                        <div className="h-px relative shrink-0 w-[16px]" data-name="Container">
                          <div aria-hidden="true" className="absolute border-[#bfc2c4] border-solid border-t inset-0 pointer-events-none" />
                        </div>
                      ...
                      <div className="absolute content-stretch flex h-[35px] items-center left-0 pl-[36px] pr-[10.5px] rounded-[8px] top-0 w-[233px]" data-name="Button">
                        <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[21px] relative shrink-0 text-[#484e56] text-[14px] w-[170px] whitespace-pre-wrap">Company Overview</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="relative shrink-0" data-name="Text">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center relative">
                        <div className="relative shrink-0 size-[20px]" data-name="verified_user">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                            <g clipPath="url(#clip0_39_46857)" id="verified_user">
                              <mask height="20" id="mask0_39_46857" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
                                <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
                              </mask>
                              <g mask="url(#mask0_39_46857)">
                                <path d={svgPaths.p1a78ceb0} fill="var(--fill-0, #131A25)" id="verified_user_2" />
                              </g>
                            </g>
                            <defs>
                              <clipPath id="clip0_39_46857">
                  ...
                  <div className="flex flex-row items-center size-full">
                    <div className="content-stretch flex items-center justify-between px-[12px] relative w-full">
                      ...
                      <div className="absolute content-stretch flex gap-[20px] h-[35px] items-center left-0 pl-[36px] pr-[10.5px] rounded-[8px] top-0 w-[233px]" data-name="Button">
                        <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#104eb8] text-[14px] w-[170px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                          Legal History
                        </p>
                    ...
                    <div className="content-stretch flex items-center justify-between px-[12px] relative w-full">
                      ...
                      <div className="absolute content-stretch flex h-[35px] items-center justify-between left-0 pl-[36px] pr-[10.5px] rounded-[8px] top-0 w-[362px]" data-name="Button">
                        <div className="h-[21px] relative shrink-0 w-[186.266px]" data-name="Text">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                            <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[21px] left-0 text-[#484e56] text-[14px] top-[0.5px]">Operational Markers</p>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div className="absolute bottom-0 h-[1430px] left-0 pointer-events-none top-0">
        <div className="bg-[#09132a] h-[900px] pointer-events-auto sticky top-0 w-[80px]" data-name="sidebar/collapsed">
          ...
          <div className="absolute content-start flex flex-wrap gap-[4px] items-start left-0 top-[50px] w-[80px]">
            ...
            <div className="bg-[rgba(23,102,214,0.32)] content-stretch flex gap-[4px] h-[48px] items-center justify-center p-[10px] relative shrink-0 w-[80px]">
              <Wrapper3 additionalClassNames="h-[44px]">
      ...
      <div className="absolute bottom-0 h-[1430px] left-[80px] pointer-events-none top-0">
      ...
      <div className="absolute bottom-0 h-[1381px] left-[80px] pointer-events-none top-[49px]">
        <div className="content-stretch flex flex-col items-start pointer-events-auto sticky top-0 w-[1360px]">
          ...
          <div className="bg-white content-stretch flex items-center justify-between p-[8px] relative shrink-0 w-[1359px]">
            <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[440px]">
              ...
              <Wrapper3 additionalClassNames="h-[24px]">
                <div className="flex-none rotate-90">
                  ...
                  <div className="flex items-center justify-center relative shrink-0">
                    <div className="flex-none rotate-180">
                      <div className="relative size-[24px]" data-name="arrow_drop_up">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                          <g clipPath="url(#clip0_39_46849)" id="arrow_drop_up">
                            <mask height="24" id="mask0_39_46849" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
                              <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
                            </mask>
                            <g mask="url(#mask0_39_46849)">
                              <path d={svgPaths.p2c475671} fill="var(--fill-0, #1C1B1F)" id="arrow_drop_up_2" />
                            </g>
                          </g>
                          <defs>
                            <clipPath id="clip0_39_46849">
