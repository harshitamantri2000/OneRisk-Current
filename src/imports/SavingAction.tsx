...
import svgPaths from "./svg-az0nms7ok4";
type Wrapper4Props = {
...
function Wrapper3({ children, text, additionalClassNames = "" }: React.PropsWithChildren<Wrapper3Props>) {
  return (
    <Wrapper4 additionalClassNames={additionalClassNames} additionalClassNames={clsx("bg-[rgba(19,26,37,0.1)]", additionalClassNames)}>
...
function Helper1({ additionalClassNames = "" }: Helper1Props) {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <ContentCellText text="bbbbcf..." />
      <ContentCell />
      <BadgeChipText text="Sanctions" additionalClassNames="bg-white" />
      <ContentCell1 />
      <Wrapper4 additionalClassNames="bg-[#131a25]">
        <Text text="False Positive" additionalClassNames="text-white" />
      </Wrapper4>
      <ContentCellText2 text="View Details" />
    </div>
  );
}
...
function ContentCell1({ additionalClassNames = "" }: ContentCell1Props) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-row items-center size-full">
        <Text5 text="2W6IR17E23" additionalClassNames="px-[8px]" />
      </div>
    </div>
  );
}
...
function ContentCell({ additionalClassNames = "" }: ContentCellProps) {
  return (
    <div className="relative shrink-0 w-[132px]">
      <div className="flex flex-row items-center size-full">
        <Text5 text="YYYY" additionalClassNames="px-[8px]" />
      </div>
    </div>
  );
}
...
function Wrapper1({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper1Props>) {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      ...
      <BadgeChipText text="Sanctions" additionalClassNames="bg-white" />
      <ContentCell1 />
      <Wrapper3 text="Pending" additionalClassNames="text-[#131a25]" />
...
function ContentCellText1({ text, additionalClassNames = "" }: ContentCellText1Props) {
  return (
    <div className={clsx("relative", additionalClassNames)}>
      <div className="flex flex-row items-center size-full">
        <Text5 text={text} additionalClassNames="px-[8px]" />
      </div>
    </div>
  );
}
...
function ContentCellText({ text, additionalClassNames = "" }: ContentCellTextProps) {
  return (
    <div className={clsx("flex-[1_0_0] min-h-px min-w-px relative", additionalClassNames)}>
      <div className="flex flex-row items-center size-full">
        <Text5 text={text} additionalClassNames="px-[16px]" />
      </div>
    </div>
  );
}
...
function Wrapper({ text, text1, text2, text3, children, additionalClassNames = "" }: React.PropsWithChildren<WrapperProps>) {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <ContentCellText text={text} />
      <ContentCellText1 text={text1} additionalClassNames="shrink-0 w-[132px]" />
      <BadgeChipText text={text2} additionalClassNames="bg-white" />
      <ContentCellText1 text={text3} additionalClassNames="flex-[1_0_0] min-h-px min-w-px" />
      <Wrapper4 additionalClassNames="bg-[#1766d6]">
        <Text text="True Positive" additionalClassNames="text-white" />
      </Wrapper4>
      <Wrapper2>{children}</Wrapper2>
    </div>
  );
...
function Text2({ text, additionalClassNames = "" }: Text2Props) {
  return (
    <div style={{ fontFeatureSettings: "'case'" }} className={clsx("flex flex-[1_0_0] flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium justify-center leading-[0] min-h-px min-w-px relative text-[16px] tracking-[0.064px]", additionalClassNames)}>
...
function LeftContentText({ text }: LeftContentTextProps) {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-h-px min-w-px relative">
      <Text2 text={text} additionalClassNames="text-[#bfc2c4]" />
    </div>
  );
}
...
export default function SavingAction() {
  return (
    <div className="bg-[#f3f3f4] relative size-full" data-name="Saving action">
      ...
      <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-[80px] top-[73px] w-[1360px]">
        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
          <div className="bg-white relative shrink-0 w-full" data-name="left-container">
          ...
          <div className="bg-[#ebf6fe] relative shrink-0 w-full">
            <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative w-full">
                <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[#0b3a9a] text-[14px] tracking-[0.056px]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                  Decision saved successfully! Your report is now available for download.
                </p>
              </div>
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[1265px]">
          <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
            <div className="bg-white content-stretch flex flex-col h-[206px] items-start overflow-clip px-[12px] py-[8px] relative rounded-[12px] shrink-0 w-[481px]">
              <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
                <div className="content-stretch flex items-center relative shrink-0 w-full">
                  <Text1 text="Case Input" additionalClassNames="shrink-0" />
                </div>
            ...
            <div className="bg-white content-stretch flex flex-col gap-[16px] items-start overflow-clip px-[12px] py-[8px] relative rounded-[12px] shrink-0 w-[767px]">
              <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
                <Text1 text="Case Decision" additionalClassNames="flex-[1_0_0] min-h-px min-w-px" />
                <div className="bg-white h-[28px] relative rounded-[4px] shrink-0" data-name="button">
                  <div aria-hidden="true" className="absolute border border-[#1766d6] border-solid inset-0 pointer-events-none rounded-[4px]" />
                  <div className="flex flex-row items-center justify-center size-full">
                    <div className="content-stretch flex gap-[8px] h-full items-center justify-center px-[24px] relative">
                      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[#1766d6] text-[14px] text-center tracking-[0.056px]" style={{ fontFeatureSettings: "'case', 'liga' 0" }}>
                        Save
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="h-[69px] relative shrink-0 w-[291px]" data-name="Input (Box)">
                    <div className="content-stretch flex flex-col gap-[5px] items-start relative size-full">
                      ...
                      <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Input-Box">
                        <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                          <div className="content-stretch flex gap-[12px] items-center px-[16px] py-[4px] relative size-full">
                            <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-h-px min-w-px relative" data-name="left-content">
                              <Text2 text="High Risk" additionalClassNames="text-[#e23318]" />
                            </div>
                            <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="right-content">
                              <IconFiChevronDown className="overflow-clip relative shrink-0 size-[20px]" />
                            </div>
                  ...
                  <div className="content-stretch flex gap-[16px] items-center px-[16px] relative w-full">
                    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Metrics-cell">
                      ...
                      <div className="content-stretch flex flex-col gap-[2px] items-start px-[16px] py-[8px] relative w-full">
                        <Text3 text="All Hits" additionalClassNames="w-full" />
                        <Text4 text="100" />
                      </div>
                    </div>
                    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Metrics-cell">
                      ...
                      <div className="content-stretch flex flex-col gap-[2px] items-start px-[16px] py-[8px] relative w-full">
                        <Text3 text="Sanctions" additionalClassNames="w-full" />
                        <div className="content-stretch flex items-center relative shrink-0 w-full">
                    ...
                    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Metrics-cell">
                      <div aria-hidden="true" className="absolute border border-[#e7e8e9] border-solid inset-0 pointer-events-none rounded-[12px]" />
                      <div className="content-stretch flex flex-col gap-[2px] items-start px-[16px] py-[8px] relative w-full">
                        <Text3 text="PEP" additionalClassNames="w-full" />
                        <Text4 text="0" />
                      </div>
                    </div>
                    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Metrics-cell">
                      <div aria-hidden="true" className="absolute border border-[#e7e8e9] border-solid inset-0 pointer-events-none rounded-[12px]" />
                      <div className="content-stretch flex flex-col gap-[2px] items-start px-[16px] py-[8px] relative w-full">
                        <Text3 text="Warning" additionalClassNames="w-full" />
                        <Text4 text="0" />
                      </div>
                    </div>
                    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Metrics-cell">
                      ...
                      <div className="content-stretch flex flex-col gap-[2px] items-start px-[16px] py-[8px] relative w-full">
                        <div className="content-stretch flex items-start relative shrink-0 w-full">
                          <Text3 text="Adverse media" additionalClassNames="w-[186px]" />
                        </div>
                        <div className="content-stretch flex items-center relative shrink-0 w-full">
              ...
              <div className="relative rounded-[12px] shrink-0 w-full">
                <div className="overflow-clip rounded-[inherit] size-full">
                  <div className="content-stretch flex flex-col items-start px-[16px] relative w-full">
                    <div className="content-stretch flex flex-col gap-[8px] h-[676px] items-start relative rounded-[12px] shrink-0 w-full">
                      <div aria-hidden="true" className="absolute border border-[#e7e8e9] border-solid inset-0 pointer-events-none rounded-[12px]" />
                      <div className="bg-[#f3f3f4] content-stretch flex items-start rounded-tl-[12px] rounded-tr-[12px] shrink-0 sticky top-0 w-[1232px]">
                        ...
                        <div className="shrink-0 sticky top-0 w-[132px]" data-name="Content Cell">
                          <div className="flex flex-row items-center size-full">
                        ...
                        <div className="flex-[1_0_0] min-h-px min-w-px sticky top-0" data-name="Content Cell">
                          <div className="flex flex-row items-center size-full">
                            <Frame1943Text text="Categories" additionalClassNames="px-[8px]" />
                          </div>
                        </div>
                        <div className="flex-[1_0_0] min-h-px min-w-px sticky top-0" data-name="Content Cell">
                          <div className="flex flex-row items-center size-full">
                            <Frame1943Text text="Source" additionalClassNames="px-[8px]" />
                          </div>
                        </div>
                        <Frame1943ContentCellText text="Status" additionalClassNames="rounded-tr-[4px]" />
                        <Frame1943ContentCellText text="&nbsp;" additionalClassNames="rounded-tl-[20px] rounded-tr-[20px]" />
                      </div>
                      <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px overflow-clip relative rounded-[8px] w-full">
                        <Wrapper text="bbbbcf..." text1="YYYY" text2="Sanctions" text3="2W6IR17E23">
                          View Details
                        </Wrapper>
                        <Wrapper text="bbbbcf..." text1="YYYY" text2="Sanctions" text3="2W6IR17E23">
                          View Details
                        ...
                        <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="8">
                          <ContentCellText text="bbbbcf..." />
                          <ContentCell />
                          <BadgeChipText text="Sanctions" additionalClassNames="bg-white" />
                          <ContentCell1 />
                          <Wrapper3 text="Skipped" additionalClassNames="text-[#131a25]" />
                          <ContentCellText2 text="View Details" />
                        </div>
                        <Wrapper1>View Details</Wrapper1>
                        <Wrapper1>View Details</Wrapper1>
                        ...
                        <Wrapper1>View Details</Wrapper1>
                        <Wrapper1>View Details</Wrapper1>
                        <div className="content-stretch flex items-start relative rounded-bl-[12px] shrink-0 w-full" data-name="14">
                          <ContentCellText text="bbbbcf..." additionalClassNames="rounded-bl-[12px]" />
                          <ContentCell />
